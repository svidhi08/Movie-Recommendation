# First selects ~30 similar movies using content-based filtering,
# then ranks ONLY those movies using CF (SVD) for a given user.
...
# CONFIG
# -----------------------------
CONTENT_TOP_K = 30   # content-based candidates
...
tfidf = TfidfVectorizer(
    stop_words="english",
    ngram_range=(1, 2),
    max_features=20000  # prevents memory blow-up
)
...
movie_to_index = dict(zip(movies['movieId'], movies.index))
